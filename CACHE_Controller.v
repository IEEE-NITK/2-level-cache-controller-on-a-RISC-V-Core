...
parameter no_of_l1_blocks = 32;       // No. of lines in L1 Cache... as one line contains 1 block...it is equal to no. of blocks
...
parameter no_of_l1_index_bits = 5;    //as 2^6=64... So 6 index bits are sufficient to locate a line on L1 Cache
parameter no_of_l1_tag_bits = 25;     //No. of tag bits= Address_bits - index_bits- Block_offset = 32 -6 -2 =24
...
parameter no_of_l2_blocks = 64;      //No. of lines in L2 Cache... each line is a set of 4 blocks here
...
parameter no_of_l2_index_bits = 6;     // 2^7=128 <= No. of L2 block lines.....So 7 bits are used here to get the no. of line on L2 Cache
parameter no_of_l2_tag_bits = 24;      //No. of tag bits= Address_bits - index_bits- Block_offset = 32 -9 -2 =23
...
parameter no_of_main_memory_blocks = 1024; //2^14 //No. of lines in main_memory... as each line contains a single block... No. of lines=No. of blocks here
...
parameter main_memory_byte_size = 4096;           //No. of bytes in main memory=No. of lines* No. of bytes in each line=16384*4=65536
...
reg l1_to_l2_search3;
       ...
       ///// *** CACHE CONTROLLER LOGIC STARTS FROM HERE *** \\\\\
...
begin
    ...
    l1_index = (main_memory_blk_id) % no_of_l1_blocks ;  //The index in L1 Cache for the address
